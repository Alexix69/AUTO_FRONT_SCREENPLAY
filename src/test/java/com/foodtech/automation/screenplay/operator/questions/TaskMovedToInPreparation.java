...
public class TaskMovedToInPreparation implements Question<Boolean> {

    public static TaskMovedToInPreparation afterStartAction() {
        return new TaskMovedToInPreparation();
    }
